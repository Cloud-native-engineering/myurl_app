        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item" v-if="isAuthenticated">
              <router-link to="/url" class="nav-link">Url</router-link>
            </li>
          </ul>
          <ul class="navbar-nav d-none d-md-block">
            ...
            <li class="nav-item dropdown" v-if="isAuthenticated">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-header">{{ apiUser }}</div>
            ...
            <li class="nav-item">
              <span class="user-info">
                <img
                  ...
                  width="50"
                />
                <h6 class="d-inline-block">{{ apiUser }}</h6>
              </span>
            </li>
            <li>
  ...
  setup() {
    ...
    const fetchUsername = async () => {
      if (auth0.isAuthenticated.value) { // Check if the user is authenticated
        ...
        apiUser.value = data.username; // Correctly store the username in apiUser.value
      }
    };
    ...
    watch(auth0.isAuthenticated, (newValue) => {
      if (newValue) { // If the user is authenticated
